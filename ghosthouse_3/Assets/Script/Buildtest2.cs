...
public class Buildtest2 : MonoBehaviour {
    ...
    //public CheckCollider G_PCheck;
    public GameObject G_Preview1; //벽미리보기(설치불가)
    //public CheckCollider G_P1Check;
    //public GameObject G_PvRoad; //길미리보기(설치가능)
    //public GameObject G_PvRoad1; //길미리보기(설치불가)
    public GameObject test; //오브젝트 설치 미리보기 저장용
    public GameObject test2; //설치불가 미리보기
    public Vector3 posi; //오브젝트 위치 저장용
    public int PdCondition = 0; //설치할 오브젝트 미리보기의 종류를 나타내는 변수
    public int PdType = 0; //설치할 오브젝트의 종류를 나타내는 변수

    static Buildtest2 m_cInstance;

    static public Buildtest2 GetInstance()
    {
        return m_cInstance;
    }
